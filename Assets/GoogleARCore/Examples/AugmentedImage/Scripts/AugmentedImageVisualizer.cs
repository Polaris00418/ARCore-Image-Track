...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    public class AugmentedImageVisualizer : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            //show AR Oject on Tracked Augmented Image
            string texture_path = String.Format("Textures/{0}", Image.Name);
            AROject.GetComponent<MeshRenderer>().material.mainTexture = Resources.Load<Texture>(texture_path);
            //AROject.transform.localScale = new Vector3(Image.ExtentX, 1, Image.ExtentZ);
            AROject.transform.localScale = new Vector3(Image.ExtentX, Image.ExtentZ, 1);
        }
        ...
        {
            //show AR Oject on Tracked Augmented Image
            //string texture_path = String.Format("Textures/{0}", "000A");
            //AROject.GetComponent<MeshRenderer>().material.mainTexture = Resources.Load<Texture>(texture_path);
            //AROject.transform.localScale = new Vector3(Image.ExtentX, 1, Image.ExtentZ);
        }
    }
